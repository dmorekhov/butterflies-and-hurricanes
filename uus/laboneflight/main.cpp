...
int main() {
    ...
    while (true) {
        ...
        case 4: {
                ...
                cin >> new_flight.arrival_place;
                cout << "Enter flight cost: ";
                cin >> new_flight.cost;
                cout << "Enter departure date" << endl;
                cout << "Year: "; cin >> new_flight.departure_date.year;
                cout << "Month: "; cin >> new_flight.departure_date.month;
                cout << "Day: "; cin >> new_flight.departure_date.day;
                cout << "Hour: "; cin >> new_flight.departure_date.hour;
                cout << "Minute: "; cin >> new_flight.departure_date.minute;
